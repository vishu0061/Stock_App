        ...
        _buildPerformanceChart: function () {
            ...
            const sHtmlContent = `
                <div class="tv-chart-container" style="position: relative; width: 100%; height: 320px; overflow: visible;">
                    ...
                    <script>
                        (function() {
                            var svg = document.getElementById("tvPerfSvg");
                            svg.pointsData = ${JSON.stringify(aPointsWithCoords)};
                            svg.baselineValue = ${totalCost};
                            
                            if (!window.tvPerfHover) {
                                window.tvPerfHover = function (evt, svgEl) {
                                    ...
                                    if (dot) {
                                        ...
                                        dot.setAttribute("fill", pt.value >= svgEl.baselineValue ? "#10b981" : "#ef4444");
                                    ...
                                    if (tooltip) {
                                        ...
                                        tooltip.querySelector(".tt-inv").innerText = "₹" + svgEl.baselineValue.toLocaleString("en-IN", {minimumFractionDigits: 2});
                                        
                                        var diff = pt.value - svgEl.baselineValue;
